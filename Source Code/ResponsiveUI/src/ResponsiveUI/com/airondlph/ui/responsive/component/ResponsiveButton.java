...
import com.airondlph.ui.responsive.factory.ResponsiveButtonFactory;
 ...
 * @author Airondlph
 *
 * Button that changes its size based in 3 metrics:
 ...
 * 
 */
public class ResponsiveButton extends JButton implements ResponsiveSize, ResponsiveLocation {
    // Size
    ...
    public ResponsiveButton(String text, RelativeSize relativeSize, AbsoluteSize minimumSize, AbsoluteSize maximumSize) {
        this( text, relativeSize, minimumSize, maximumSize, null, null, null );
    }
    
    public ResponsiveButton(String text, RelativeLocation relativeLocation, AbsoluteLocation minimumLocation, AbsoluteLocation maximumLocation) {
        this( text, null, null, null, relativeLocation, minimumLocation, maximumLocation);
    }
    
    public ResponsiveButton(String text, RelativeSize relativeSize, AbsoluteSize minimumSize, AbsoluteSize maximumSize, RelativeLocation relativeLocation, AbsoluteLocation minimumLocation, AbsoluteLocation maximumLocation) {
        super();
    ...
    public ResponsiveButton(ResponsiveButton responsiveTextButton) {
        copy(responsiveTextButton);
    }
    ...
    // Builder/Factory
    @Override
    public ResponsiveButtonFactory getFactory() {
        return new ResponsiveButtonFactory(this);
    }
    
    // Copy and Clone
    public final void copy(ResponsiveButton responsiveTextButton){
        setRelativeSize(responsiveTextButton.getRelativeSize());
        setMinSize(responsiveTextButton.getMinSize());
        setMaxSize(responsiveTextButton.getMaxSize());
        
        setRelativeLocation(responsiveTextButton.getRelativeLocation());
        setMinLocation(responsiveTextButton.getMinLocation());
        setMaxLocation(responsiveTextButton.getMaxLocation());
    }
    
    public final ResponsiveButton clone() {
